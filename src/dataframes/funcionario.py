...
func_log_path = os.path.join(actual_directory,"..","..","data","func_log.xlsx")
...
def create_func_situacao_df(func_df:'pd.DataFrame'):
    ...
    func_situacao_df.to_excel(func_log_path,index=False)
...
if os.path.exists(func_log_path):
    # Carregue os cabeçalhos da planilha existente
    func_situacao_df = get_func_situacao(func_log_path)
